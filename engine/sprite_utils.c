...
/*   Updated: 2023/12/22 19:34:52 by abuonomo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	frame_sprite(t_cub3d *cub3d)
{
	...
	if (cub3d->current_sprite == 1)
		load_image(&cub3d->egg, "./assets/sprite/Egg1_23.xpm", cub3d);
	if (cub3d->current_sprite == 2)
		load_image(&cub3d->egg, "./assets/sprite/Egg2_32.xpm", cub3d);
	if (cub3d->current_sprite == 3)
		load_image(&cub3d->egg, "./assets/sprite/Egg3_32.xpm", cub3d);
	if (cub3d->current_sprite == 4)
		load_image(&cub3d->egg, "./assets/sprite/Egg4_32.xpm", cub3d);
}
